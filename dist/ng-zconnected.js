...
$templateCache.put("/templates/templates/ngMultiselectChecklist.html","<div class=checklist-container><input type=text><ul class=checkbox-list><li data-ng-repeat=\"item in itemsList\"><input type=checkbox data-checklist-model=selectedList data-checklist-value=item[displayProperty]><p>{{item[displayProperty]}}</p></li></ul></div>");
