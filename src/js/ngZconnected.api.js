angular.module('ngZconnected.api', ['ngResource', 'ngCookies', 'ngFileUpload', 'ngZconnected', 'LocalStorageModule', 'angular-md5'])
    ...
    .service('employerService', [
        ...
        '$filter',
        'md5',
        function employerService($resource, ngZconnected, Upload, $http, $q, localStorageService, $filter, md5) {
            var self = this;
            var apiRoot = ngZconnected.apiUrl;
            ...
            self.cv = {
                ...
                storeSearchFilter: function(userId, companyId, filter) {
                    var storageName = this.filterKey + userId + companyId;
                ...
                getSearchHistory: function(userId, companyId) {
                    var keywords = angular.fromJson(localStorageService.get(this.filterKey + userId + companyId));
                    return keywords || [];
                },
